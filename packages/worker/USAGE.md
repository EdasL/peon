...
This document describes all environment variables used by Peon Workers. Most of these are automatically set by the Gateway orchestrator and should not be manually configured.
...
**Format**: `peon-worker-{user}-{timestamp}-{random}`
**Example**: `peon-worker-u123abc-284-707819`
**Set by**: Gateway orchestrator
...
DEPLOYMENT_NAME=peon-worker-<user>-<timestamp>
HOME=/workspace
```
