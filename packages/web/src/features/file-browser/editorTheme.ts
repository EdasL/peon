/**
 * CodeMirror theme matching the Peon dark UI.
 *
...
export const peonTheme = EditorView.theme(
  {
    '&': {
...
/** Syntax highlighting colors for the Peon theme. */
export const peonHighlighting = syntaxHighlighting(
